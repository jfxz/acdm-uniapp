...
<template>
	<view class="inner-form">
		...
		<view class="form">
			...
			<view class="btn-row">
				<view class="btn" @tap="createPalletBox">
					发送
				</view>
			</view>
		</view>
...
<script>
	import { createPalletBox, onError } from '@/api/empty-container/index.js'
	...
	export default {
		...
		methods: {
			createPalletBox () {
				...
				createPalletBox(this.form).then(res => {
					console.log('createPalletBox', res)
					if (res.status) {
