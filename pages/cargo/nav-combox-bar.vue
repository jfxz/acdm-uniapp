				...
				<view class="operation-search" style="margin-top: -1rpx;padding-top:1rpx">
					...
					<view class="search" v-if="history">
						<view class="search-input">
							<uni-combox @input="inputSearch" :candidates="candidates" placeholder="请输入集装器号" v-model="inputValueInner"></uni-combox>
...
<script>
	import uniCombox from '@/components/uni-combox-input/uni-combox.vue'
