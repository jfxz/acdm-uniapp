<template>
  <view class="pass-layout">
    <view class="total">
      ...
      <view class="total-text">今年累计放行正常率{{ formatFixed2Value(totalRate) }}%</view>
      ...
      getDayAndMonthRate(para)
        .then(res => {
          if (res.status) {
            ...
            let markLineVal = this.indexParams.markLineVal[`${this.airportCode}timerDaliyPass`]
            ...
            this.chartDataMonth = Object.assign({}, this.chartDataMonth, {
              ...
              series: [{ name: '月放行正常率', data: val }],
              flag: this.indexParams.markLineFlag.MonthPassRate || false,
              markLineVal: this.indexParams.markLineVal[`${this.airportCode}MonthPassRate`] || 0
            })
            this.$nextTick(() => {
            ...
            //   }, (this.indexParams.timer.MonthPassRate || 60) * 1000)
            // }
          }
        })
        .catch(e => {
        ...
        .then(res => {
          if (res.status) {
            ...
            this.chartData = Object.assign({}, this.chartData, {
              categories: xAxisData,
              series: [{ name: '日放行正常率', data: val }],
              flag: this.indexParams.markLineFlag.timerDaliyPass || false,
              markLineVal: this.indexParams.markLineVal[`${this.airportCode}timerDaliyPass`] || 70
            })
            
            console.log('chartData123', this.chartData)
