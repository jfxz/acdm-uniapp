  ...
  <view class="release-layout">
    ...
    <view class="" v-if="!bottomLoadFail">
      <view class="releaseDelayTotal">
        ...
        <view class="qiun-charts2"><canvas canvas-id="canvasColumn" id="canvasColumn" class="charts2" @touchstart="touchColumn"></canvas></view>
      </view>
      <view class="btns">
    ...
    <view class="forecast-class">
      <view class="qiun-charts3"><canvas canvas-id="canvasRing" id="canvasRing1" class="charts3"></canvas></view>
      <view class="qiun-charts3"><canvas canvas-id="canvasRing" id="canvasRing2" class="charts3"></canvas></view>
      <view class="qiun-charts3"><canvas canvas-id="canvasRing" id="canvasRing3" class="charts3"></canvas></view>
      <view class="qiun-charts3"><canvas canvas-id="canvasRing" id="canvasRing4" class="charts3"></canvas></view>
    </view>
    ...
    <view class="">
      ...
      <view class="qiun-columns">
        ...
        <view class="qiun-charts">
          ...
          <view class="" v-else><canvas canvas-id="canvasArea" id="canvasArea" class="charts" @touchstart="touchArea"></canvas></view>
        </view>
      </view>
    </view>
  </view>
