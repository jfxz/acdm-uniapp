			...
			<scroll-view scroll-x class="u-scroll-view" :scroll-left="scrollLeft" scroll-with-animation>
				<view class="u-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
					<view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" v-for="(item, index) in list" :key="index" @tap="clickTab(index)"
					 ...
					 <view class="u-tab-next-newline-row1" v-if="isNewLineData">{{ item[name] || item['name']}}</view>
					 <view :class="['u-tab-next-newline-row2', {'isTablet': isTablet}]" v-if="isNewLineData">{{item['num']}}</view>
					 <view v-if="!isNewLineData">{{ item[name] || item['name']}}</view>
					</view>
...
<script>
	...
	export default {
		...
		mounted() {
      console.log('isTablet11', getApp().globalData.isTablet)
...
<style lang="scss" scoped>
	...
	.u-tab-next-newline-row1{
		height: 50%;
		line-height: 30px;
	}
	.u-tab-next-newline-row2{
		height: 50%;
		line-height: 15px;
		font-size: 10px;
    &.isTablet {
