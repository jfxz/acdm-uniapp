<template>
  <view class="min-badge">
    <slot></slot>
    <view class="min-badge-dot" v-if="dot" @click="deleteItem(arr, item)">
			<image style="height:16rpx;width:16rpx;" src="@/static/del2.png"></image>
		</view>
...
export default {
  ...
  computed: {
	...
	methods: {
		deleteItem (arr, item) {
			this.$emit('deleteImage', arr, item)
		}
	}
}
</script>
