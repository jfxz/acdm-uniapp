...
*  界面名称: 数字翻牌（单个）组件
*  界面功能: 提供单个数字变化是的翻牌效果
*  其他      https://www.cnblogs.com/guchengnan/p/11984168.html
*  时间      2020-12-14 15:10:50
*  作者      zql
 */
<template>
...
.M-Flipper.down .back:after {
  ...
  transform: perspective(320rpx) rotateX(180deg);
}
...
@keyframes frontFlipDown {
  0% {
    transform: perspective(320rpx) rotateX(0deg);
  }
